...
switch($_POST['type_ajout']) {
    case 'enseignant':
        $date = date("Y:m:d");
        $req=$connexion->query("INSERT INTO donnees VALUES('" . $_POST['id_pers'] . "','$date','$date','" . $_POST["nom"] . "','" . $_POST["prenom"] . "','" . $_POST["cnu"] . "','" . $_POST["fid_stat"] . "','" . $_POST["telephone"] . "','" . $_POST["email"] . "','" . $_POST["miage"] . "','" . $_POST["lib_pers"] . "','" . $_POST["last_years"] . "','" . $_POST["fid_cmp"] . "','" . $_POST["fid_cod_apo"] ."');");
        break;
    case 'tutorat':
